...
class _AdvancedProductCatalogState extends State<AdvancedProductCatalog> {
  ...
  String t(BuildContext context, String key) {
    ...
    final values = <String, Map<String, String>>{
      ...
      'subtitle': {
        'tr':
            'Marka, aroma ve ambalaj seçeneklerini inceleyin; ürün detaylarını açın ve doğrudan teklif talebi oluşturun.',
        'en':
            'Explore brands, flavors and packaging options, open product details and request a quote directly.',
        'ar':
            'استعرض العلامات والنكهات وخيارات التعبئة، وافتح تفاصيل المنتج واطلب عرض سعر مباشرة.',
        'es':
            'Explore marcas, sabores y envases, vea los detalles y solicite una cotización.',
        'pt':
            'Explore marcas, sabores e embalagens, veja detalhes e solicite uma cotação.',
        'ru':
            'Изучайте бренды, вкусы и упаковку, открывайте детали и запрашивайте цену.',
        'fr':
            'Explorez marques, saveurs et emballages, consultez les détails et demandez un devis.',
        'de':
            'Marken, Geschmacksrichtungen und Verpackungen entdecken und direkt ein Angebot anfragen.',
      },
      'search': {
      ...
      'format': {
        ...
        'en': 'Packaging format',
        'ar': 'نوع العبوة',
        'es': 'Formato de envase',
        'pt': 'Formato da embalagem',
        'ru': 'Формат упаковки',
        'fr': 'Format d’emballage',
        'de': 'Verpackungsformat',
      },
      'moq': {
        'tr': 'Minimum sipariş',
        'en': 'Minimum order',
      ...
      'singleServe': {
        'tr': 'Tek kullanımlık saşe',
        'en': 'Single-serve sachet',
        'ar': 'ظرف فردي',
        'es': 'Sobre individual',
        'pt': 'Sachê individual',
        'ru': 'Порционный саше',
  ...
  Widget build(BuildContext context) {
    final brands = [
      'all',
      ...{for (final product in products) product.brand},
    ];
    final visibleProducts = products.where((product) {
      final matchesBrand =
          selectedBrand == 'all' || product.brand == selectedBrand;
      final haystack = '${product.brand} ${t(context, product.flavorKey)}'
          .toLowerCase();
                    ...
                    builder: (context, constraints) {
                      ...
                      final details = Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 26),
                          _SpecRow(
                            label: t(context, 'weight'),
                            value: product.weight,
                          ),
                          _SpecRow(
                            label: t(context, 'format'),
                            value: t(context, 'singleServe'),
                          ),
                          _SpecRow(
                            label: t(context, 'moq'),
                            value: t(context, 'container'),
                          ),
                          const SizedBox(height: 28),
                          SizedBox(
                            width: double.infinity,
      ...
      child: Row(
        children: [
          Expanded(
            child: Text(
              label,
              style: const TextStyle(color: Color(0xFF6C7D88)),
            ),
          ),
          Text(
            value,
