...
class AppI18n {
  ...
  static const Map<String, Map<String, String>> _values = {
    ...
    'app.platform': {
      'tr': 'TEK PLATFORM', 'en': 'ONE PLATFORM', 'ar': 'منصة واحدة',
      'es': 'UNA PLATAFORMA', 'pt': 'UMA PLATAFORMA',
      'ru': 'ЕДИНАЯ ПЛАТФОРМА', 'fr': 'UNE SEULE PLATEFORME',
      'de': 'EINE PLATTFORM',
    },
    'nav.home': {
    ...
    'home.heroSubtitle': {
      'tr': 'EMAN ONE; toptan satış, küresel satış ortaklığı, fabrika operasyonları ve yönetim kararlarını tek profesyonel platformda birleştirir.',
      'en': 'EMAN ONE unifies wholesale sales, global partner growth, factory operations and executive decisions in one professional platform.',
      'ar': 'تجمع EMAN ONE مبيعات الجملة وشبكة الشركاء العالمية وعمليات المعمل وقرارات الإدارة ضمن منصة احترافية واحدة.',
      'es': 'EMAN ONE reúne ventas mayoristas, socios globales, operaciones de fábrica y decisiones ejecutivas en una sola plataforma.',
      'pt': 'A EMAN ONE reúne vendas por atacado, parceiros globais, operações de fábrica e decisões executivas em uma única plataforma.',
      'ru': 'EMAN ONE объединяет оптовые продажи, глобальных партнёров, производство и управленческие решения в одной платформе.',
      'fr': 'EMAN ONE réunit ventes en gros, partenaires mondiaux, opérations d’usine et décisions de direction sur une seule plateforme.',
      'de': 'EMAN ONE vereint Großhandel, globale Partner, Werksbetrieb und Managemententscheidungen auf einer Plattform.',
    },
    'home.exploreProducts': {
      'tr': 'Ürünleri Keşfet', 'en': 'Explore Products', 'ar': 'استكشف المنتجات',
      'es': 'Explorar productos', 'pt': 'Explorar produtos',
      'ru': 'Смотреть продукты', 'fr': 'Découvrir les produits',
      'de': 'Produkte entdecken',
    },
    'home.becomePartner': {
      'tr': 'Satış Ortağı Ol', 'en': 'Become a Sales Partner',
      'ar': 'كن شريك مبيعات', 'es': 'Ser socio comercial',
      'pt': 'Seja parceiro de vendas', 'ru': 'Стать партнёром',
      'fr': 'Devenir partenaire commercial', 'de': 'Vertriebspartner werden',
    },
    'home.proofGlobal': {
      'tr': 'Dünya çapında çalışma', 'en': 'Work worldwide',
      'ar': 'اعمل من أي مكان', 'es': 'Trabaja globalmente',
      'pt': 'Trabalhe globalmente', 'ru': 'Работа по всему миру',
      'fr': 'Travaillez partout', 'de': 'Weltweit arbeiten',
    },
    'home.proofFactory': {
      'tr': 'Fabrika ile tam bağlantı', 'en': 'Connected to factory operations',
      'ar': 'مرتبط مباشرة بإدارة المعمل', 'es': 'Conectado con la fábrica',
      'pt': 'Conectado à fábrica', 'ru': 'Связь с производством',
      'fr': 'Connecté à l’usine', 'de': 'Mit dem Werk verbunden',
    },
    'home.proofCommission': {
      'tr': 'Şeffaf komisyon takibi', 'en': 'Transparent commission tracking',
      'ar': 'تتبّع شفاف للعمولات', 'es': 'Seguimiento transparente',
      'pt': 'Comissões transparentes', 'ru': 'Прозрачные комиссии',
    ...
    'home.badgeCountriesLabel': {
      'tr': 'aktif ülke', 'en': 'active countries', 'ar': 'دولة نشطة',
      'es': 'países activos', 'pt': 'países ativos',
      'ru': 'активных стран', 'fr': 'pays actifs', 'de': 'aktive Länder',
    },
    'home.badgePartnersValue': {'tr': '1.200+', 'en': '1,200+', 'ar': '1,200+'},
    'home.badgePartnersLabel': {
      'tr': 'satış ortağı', 'en': 'sales partners', 'ar': 'شريك مبيعات',
      'es': 'socios de ventas', 'pt': 'parceiros de vendas',
      'ru': 'партнёров', 'fr': 'partenaires', 'de': 'Vertriebspartner',
    },
    ...
    'home.capabilitiesSubtitle': {
      'tr': 'Müşteriden üretime, sevkiyattan komisyona kadar tüm süreç tek akışta.',
      'en': 'From customer to production, shipment and commission, every step stays connected.',
      ...
      'pt': 'Do cliente à produção, envio e comissão, tudo permanece conectado.',
      'ru': 'От клиента до производства, отгрузки и комиссии — всё связано.',
      'fr': 'Du client à la production, l’expédition et la commission, tout reste connecté.',
      'de': 'Vom Kunden bis Produktion, Versand und Provision bleibt alles verbunden.',
    },
    'home.cardWholesaleTitle': {
      'tr': 'Toptan Satış', 'en': 'Wholesale Commerce', 'ar': 'تجارة الجملة',
      'es': 'Comercio mayorista', 'pt': 'Comércio atacadista',
      'ru': 'Оптовая торговля', 'fr': 'Commerce de gros', 'de': 'Großhandel',
    },
    ...
    'home.cardPartnerTitle': {
      'tr': 'Küresel Satış Ağı', 'en': 'Global Sales Network',
      'ar': 'شبكة مبيعات عالمية', 'es': 'Red global de ventas',
      'pt': 'Rede global de vendas', 'ru': 'Глобальная сеть продаж',
      'fr': 'Réseau commercial mondial', 'de': 'Globales Vertriebsnetz',
    },
    'home.cardPartnerText': {
      'tr': 'Herkes satış ortağı olabilir, müşteri kazandırabilir ve komisyonunu izleyebilir.',
      'en': 'Anyone can become a partner, introduce buyers and track approved commissions.',
      'ar': 'يمكن لأي شخص أن يصبح شريكًا ويجلب العملاء ويتابع عمولاته.',
    },
    'home.cardFactoryTitle': {
      'tr': 'Fabrika Operasyonları', 'en': 'Factory Operations',
      'ar': 'عمليات المعمل', 'es': 'Operaciones de fábrica',
      'pt': 'Operações de fábrica', 'ru': 'Производственные операции',
      'fr': 'Opérations d’usine', 'de': 'Werksbetrieb',
    },
    'home.cardFactoryText': {
      'tr': 'Üretim, kalite, stok, bakım, depo ve sevkiyat yönetimi.',
      'en': 'Production, quality, inventory, maintenance, warehouse and shipping.',
    ...
    'home.cardExecutiveText': {
      ...
      'en': 'Monitor sales, production and financial performance from one view.',
    ...
    'home.partnerBannerText': {
      'tr': 'Kendi bağlantınızı paylaşın, nitelikli alıcılar kazandırın ve tamamlanan satışlardan onaylı komisyon alın.',
      'en': 'Share your personal link, introduce qualified buyers and earn approved commission from completed sales.',
      'ar': 'شارك رابطك الخاص، واجلب مشترين مؤهلين، واحصل على عمولة معتمدة من الصفقات المكتملة.',
    },
    'home.partnerBannerButton': {
      'tr': 'Hemen Başvur', 'en': 'Apply Now', 'ar': 'قدّم الآن',
      'es': 'Solicitar ahora', 'pt': 'Inscreva-se agora',
      'ru': 'Подать заявку', 'fr': 'Postuler maintenant', 'de': 'Jetzt bewerben',
    },
    'factory.title': {
